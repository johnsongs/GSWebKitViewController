#
# Be sure to run `pod lib lint GSWebKitViewController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'GSWebKitViewController'
  s.version          = '0.1.0'
  s.summary          = 'A short description of GSWebKitViewController.'
